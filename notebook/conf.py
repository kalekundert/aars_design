...
latex_documents = [ #
    (master_doc, 'aars_design.tex', 'aaRS Design',
     'Kale Kundert', 'manual'),
]
...
man_pages = [ #
    (master_doc, 'aars_design', 'aaRS Design',
     [author], 1)
]
...
texinfo_documents = [ #
    (master_doc, 'aars_design', 'aaRS Design',
     author, 'aars_design', 'One line description of project.',
     'Miscellaneous'),
]
